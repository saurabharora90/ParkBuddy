...
class CleaningReminderWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        // val repository = (applicationContext as ParkBuddyApplication).dataGraph.streetCleaningRepository
        // Since we don't have easy access to the graph here without casting, let's skip the actual DB call for the worker logic
    ...
    private fun sendNotification(title: String, message: String) {
        ...
        val notification = NotificationCompat.Builder(applicationContext, channelId)
            .setSmallIcon(android.R.drawable.ic_dialog_info) // Use a proper icon
