...
enum class SetupStep(
  ...
  LOCATION(
    ...
    subtitle =
      "ParkBuddy matches your exact location to SF's parking signs, meters, and street " +
        "cleaning schedules. Your location stays on your device.",
  ...
  BACKGROUND_LOCATION(
    ...
    subtitle =
      "Parking doesn't pause when you lock your phone. Background access lets ParkBuddy " +
        "keep watching the clock so you don't have to.",
  ...
  NOTIFICATIONS(
    ...
    subtitle =
      "ParkBuddy sends a notification before your meter expires or street cleaning " +
        "starts, giving you time to move your car.",
  ...
  PRECISE_TIMING(
    ...
    subtitle =
      "Your phone sometimes delays notifications to save battery. This ensures your " +
        "move-your-car reminder arrives exactly on time, not five minutes late.",
  ...
  BATTERY(
    ...
    subtitle =
      "Some phones aggressively close background apps. This prevents Android from " +
        "putting ParkBuddy to sleep while your car is parked.",
    buttonLabel = "Open Settings",
  ),
}
